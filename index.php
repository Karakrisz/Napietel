...
<ul class="cb-slideshow">
    ...
    <li><span>Image 10</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 11</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 12</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 13</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 14</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 15</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 16</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 17</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 18</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 19</span>
        <div><h3></h3></div>
    </li>
    <li><span>Image 20</span>
        <div><h3></h3></div>
    </li>
</ul>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-9">
            ...
            $result = $dbc->query("SELECT * FROM data") or die($dbc->error);
            $result_01 = $dbc->query("SELECT * FROM foetel") or die($dbc->error);
            $result_02 = $dbc->query("SELECT * FROM desszert") or die($dbc->error);
            $result_03 = $dbc->query("SELECT * FROM napi_menu") or die($dbc->error);
            //pre_r($result);
            //wow slideInRight
            ?>
                ...
                <table class="table col-xl-12">
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="<?= $row['kiemelt'] ? 'kiemelt' : '' ?>">
                                <i><?php echo "" . $row['ar'] . "Ft"; ?></i></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
                <table class="table col-xl-12">
